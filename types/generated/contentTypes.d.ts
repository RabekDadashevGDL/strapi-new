...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ContactLinkText: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatsUpLink: Schema.Attribute.Text;
    WhatsUpLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
  };
}
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        ...
        'news-page.all-news',
        'shared.slider',
        'main-page.text-and-image',
        'main-page.main-title',
        'main-page.main-slider',
        'main-page.main-quote',
        'shared.contact-form',
        'shared.orange-button',
        'shared.image-and-border-text',
        'shared.border-text-and-work-hours',
        'shared.contact-info-and-map',
        'shared.text-and-image',
        'shared.download-file',
        'job.job-description',
        'job.job-conditions-list',
        'job.job-contacts',
        'job.job-list',
        'shared.employees-block',
